...
#define _INTERVAL_SERVO   60 // servo interval (unit: ms)
...
#define _DUTY_NEU 1815 // 1500
#define _DUTY_MIN 1130 // 1000

#define _SERVO_ANGLE_DIFF  100  // Replace with |D - E| degree
#define _SERVO_SPEED       80  // servo speed

#define _BANGBANG_RANGE    585  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  return 993 + -4.94*a_value + 0.00785*a_value*a_value + -0.00000145*a_value*a_value*a_value + -0.00000000428*a_value*a_value*a_value*a_value;
}
