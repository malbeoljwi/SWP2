...
#define _DIST_MIN 150.0   // minimum distance to be measured (unit: mm)
...
#define _DUTY_MIN 5 // servo full clockwise position (0 degree)
...
void loop() {
  ...
  if (dist_raw<_TARGET_LOW){
    ...
    myservo.writeMicroseconds((_DUTY_MAX/_TARGET_LOW)*(dist_ema-_TARGET_LOW));
  }
